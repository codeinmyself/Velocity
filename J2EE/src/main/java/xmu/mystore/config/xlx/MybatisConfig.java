...
public class MybatisConfig {
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception {
		...
		//xing 新增
		sqlSessionFactoryBean.setTypeHandlersPackage("xmu.mystore.logmgt.xlx.TypeHandlers");
		//xing 新增
	...
	public DruidDataSource dataSource() throws SQLException {
		...
		druidDataSource.setUrl("jdbc:mysql://120.77.173.98:3306/j2ee");
		druidDataSource.setUsername("student");
		druidDataSource.setPassword("software");
		// 初始化连接大小
