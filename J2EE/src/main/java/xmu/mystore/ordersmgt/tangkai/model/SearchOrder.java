...
/**
 * @author tangkai
 * @data 2017年6月2日--下午1:19:18
 */
public class SearchOrder {
	private long order_sn; //订单ID
	...
	public SearchOrder(long order_sn, int order_status, String consignee, String goods_name, long long_before,
