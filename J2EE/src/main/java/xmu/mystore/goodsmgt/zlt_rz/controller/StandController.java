...
import xmu.mystore.goodsmgt.zlt_rz.service.StandService;
...
public class StandController {
	...
	@HasAuthority(authority="select_stand")
	@ControllerLogger(description="查看上下架", operatorObeject="stand")
	...
	@HasAuthority(authority="update_stand")
	...
	@HasAuthority(authority="update_stand")
	@ControllerLogger(description="修改上下架", operatorObeject="stand")
