...
//	}
	...
	@Override
	public String toString() {// nickname="+ nickname + ",
		return "User [user_id=" + user_id + ", user_name=" + user_name + ", password=" + password + ", mobile_phone=" + mobile_phone + ", imagepath=" + imagepath + "]";
	}
