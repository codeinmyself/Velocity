package xmu.mall.usercenter.cdd.controller;
...
import xmu.mall.usercenter.cdd.service.IMGoodsService;
import xmu.mall.usercenter.cdd.service.IMUserService;
import xmu.mall.usercenter.cdd.service.IUser_AddressService;
...
public class UserCenterController {
	...
	public String changeOrderStatus_dispaly(Model model, Long user_id, Long order_id, Integer order_status,
		...
		if (order_status == 1) {
			...
			return "cdd/user_center_body?user_id=" + user_id;
		}
	}
    ...
    public String doUploadFile(@RequestParam("file") MultipartFile file,User user,HttpServletRequest request
    	...
    	String path=request.getSession().getServletContext().getRealPath("resources/images/cdd");
